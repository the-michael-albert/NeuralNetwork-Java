...
public class Pixel
{
  ...
  public void setBrightness(int brightness){
    this.modify();
    this.setRed(brightness);
    this.setGreen(brightness);
    this.setBlue(brightness);
  }

  public int getHue(){
    float[] out = new float[3];
    out = Color.RGBtoHSB(this.getRed(), this.getGreen(), this.getBlue(), out);
    return (int) (out[0] * 256f);
  }
  public int getSat(){
    float[] out = new float[3];
    out = Color.RGBtoHSB(this.getRed(), this.getGreen(), this.getBlue(), out);
    return (int) (out[1] * 256f);
  }
  public int getBright(){
    float[] out = new float[3];
    out = Color.RGBtoHSB(this.getRed(), this.getGreen(), this.getBlue(), out);
    return (int) (out[2] * 256f);
  }
